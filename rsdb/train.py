...
def main():
    ...
    test = get_clean_review_data(url, meta_url)

    # code wrote by Jake that will export the data into file
    ...
    #     metadata_df.to_json(
    #         metadata_out_path, orient="records", lines=True, compression="gzip"
    #     )
